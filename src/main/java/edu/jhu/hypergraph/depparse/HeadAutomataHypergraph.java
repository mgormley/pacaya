...
/**
 * Hypergraph for a left or right head automata.
 * 
 * @author mgormley
 */
public class HeadAutomataHypergraph implements Hypergraph {
    
    private static final Logger log = LoggerFactory.getLogger(HeadAutomataHypergraph.class);
    ...
    public HeadAutomataHypergraph(double[] rootScores, double[][] childScores, Semiring semiring, boolean singleRoot) {
