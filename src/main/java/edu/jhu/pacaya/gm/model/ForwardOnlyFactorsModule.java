...
import edu.jhu.pacaya.gm.model.globalfac.ParamFreeGlobalFactorModule;
 ...
 * @author mgormley
 */
public class ForwardOnlyFactorsModule extends AbstractModule<Factors> implements Module<Factors> {
