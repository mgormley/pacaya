...
import edu.jhu.autodiff.erma.FgModelIdentity;
import edu.jhu.autodiff.erma.LazyVarTensor;
...
public class ConsecutiveSiblingsFactorTest {
    ...
    public void testCreateMessages() throws Exception {
        ...
        // Run once with the global factor wrapped in a non-global factor.
        
        // Run again with the global factor as normal.
