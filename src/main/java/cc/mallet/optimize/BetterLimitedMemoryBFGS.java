 ...
 *
 */
public class BetterLimitedMemoryBFGS implements Optimizer
{
	...
	private double gradientTolerance = .001;
    ...
    /**
     * The number of corrections used in BFGS update ideally 3 <= m <= 7. Larger
     * m means more cpu time, memory.
     * 
     * @param m The number of corrections.
     */
    public void setNumberOfCorrections(int m) {
        this.m = m;
    }
