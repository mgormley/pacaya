 ...
 * </dl>
 */
public interface LVector extends Iterable<LVectorEntry>, Serializable {
     ...
     * @return x
     */
    LVector set(double alpha, LVector y);
     ...
     * @return x
     */
    LVector add(double alpha, LVector y);

    /**
     * <code>x<sup>T</sup>*y</code>
     */
    double dot(LVector y);
