...
class Arrays {
     ...
     */
    public static int binarySearchGreater(long[] index, long key, int begin,
            int end) {
     ...
     *         satisfying the search criteria
     */
    public static int binarySearchGreater(long[] index, long key) {
     ...
     *         satisfying the search criteria
     */
    public static int binarySearchSmaller(long[] index, long key, int begin,
            int end) {
     ...
     *         satisfying the search criteria
     */
    public static int binarySearchSmaller(long[] index, long key) {
     ...
     */
    public static int binarySearch(long[] index, long key, int begin, int end) {
        end--;
    ...
    private static int binarySearchInterval(long[] index, long key, int begin,
