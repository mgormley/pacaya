...
public class IntDiGraphTest {
    ...
    public void testSimpleGraphWithStart() {
        ...
        assertEquals(Arrays.asList(0,1,2,3,-1), g.getNodes());
        ...
        assertEquals(Arrays.asList(0, 3), g.getSuccessors(-1));
        ...
        assertEquals(Arrays.asList(),         g.getPredecessors(-1));
        assertEquals(Arrays.asList(3, -1),    g.getPredecessors(0));
        assertEquals(Arrays.asList(0),        g.getPredecessors(1));
        assertEquals(Arrays.asList(0),        g.getPredecessors(2));
        assertEquals(Arrays.asList(1, 2, -1), g.getPredecessors(3));
    }
