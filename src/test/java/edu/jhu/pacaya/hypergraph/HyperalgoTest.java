...
import edu.jhu.pacaya.hypergraph.MemHypergraph.MemHypernode;
import edu.jhu.pacaya.util.JUnitUtils;
import edu.jhu.pacaya.util.dist.Dirichlet;
...
public class HyperalgoTest {
    ...
    public void testTinyGraph() {
        ...
        forwardBackwardCheck(graph, expected, RealAlgebra.getInstance(), null);
        forwardBackwardCheck(graph, expected, LogSignAlgebra.getInstance(), null);
    }
    ...
    public void testCkyGraph() {
        ...
        expected = forwardBackwardCheck(graph, expected, RealAlgebra.getInstance(), marginalAdj);
