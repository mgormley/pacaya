...
public class CkyPcfgParserTest {
    ...
    public void testSimpleSentence1() throws IOException {
        ...
        Pair<BinaryTreeNode, Double> pair = parseSentence("time flies like an arrow", grammar);
        BinaryTreeNode tree = pair.get1();
    ...
    public void testSimpleSentence2() throws IOException {
        ...
        Pair<BinaryTreeNode, Double> pair = parseSentence("an arrow flies like time", grammar);
        BinaryTreeNode tree = pair.get1();
        double logProb = pair.get2();
    ...
    public static Pair<BinaryTreeNode, Double> parseSentence(String sentence, CnfGrammar grammar) {
