...
import edu.jhu.hltcoe.gridsearch.dmv.DantzigWolfeRelaxation;
...
import edu.jhu.hltcoe.gridsearch.dmv.Projections;
...
import edu.jhu.hltcoe.gridsearch.dmv.DmvDantzigWolfeRelaxation.LambdaVar;
...
public class DwDmvRelaxedParser extends DantzigWolfeRelaxation {

    static Logger log = Logger.getLogger(DwDmvRelaxedParser.class);

    protected int numLambdas;

    protected DmvTrainCorpus corpus;
    protected IndexedDmvModel idm;
    protected DmvModel dmv;
    protected Stopwatch parsingTimer;
    protected MasterProblem mp;
    
    private DmvObjective dmvObj;

    public DwDmvRelaxedParser(File tempDir) {
        super(tempDir, 0);
