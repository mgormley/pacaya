...
public class DmvLpRelaxationTest {
    ...
    public void testOneWordSentence() {
        ...
        DmvLpRelaxation dw = getLp(sentences);
    ...
    public void testCutsOnManyPosTags() {
        ...
        DmvLpRelaxation dw = getLp(sentences, 20);
    ...
    private RelaxedDmvSolution testBoundsHelper(DmvLpRelaxation dw, double newL, double newU, boolean forward) {
    ...
    public void testAdditionalCuttingPlanes() {
        ...
        for (int numCuts=1; numCuts<maxCuts; numCuts++) {
            Prng.seed(12345);
            DmvLpRelaxation dw = getLp(sentences, numCuts);
            RelaxedDmvSolution relaxSol = (RelaxedDmvSolution) dw.solveRelaxation(); 
            assertEquals(0.0, relaxSol.getScore(), 1e-13);
            double maxSum = 0.0;
            double[][] logProbs = relaxSol.getLogProbs();
    ...
    public void testSemiSupervisedOnSynthetic() {
        ...
        DmvLpRelaxation dw = getLp(trainCorpus, 10);
    ...
    public void testQualityOfRelaxation() throws IOException {
        ...
        DmvLpRelaxation dw = getLp(sentences, 100);
...
//                sb.append("\n");
    ...
    private DmvLpRelaxation getLp(SentenceCollection sentences) {
        return getLp(sentences, 1);
    }
     ...
     */
    public static DmvLpRelaxation getLp(SentenceCollection sentences, final int numCuts) {
        DmvTrainCorpus corpus = new DmvTrainCorpus(sentences);
        return getLp(corpus, numCuts);
    }
