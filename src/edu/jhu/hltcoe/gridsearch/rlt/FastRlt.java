...
public class FastRlt {
    ...
    public interface RltRowFilter {
        void init(FastRlt rlt) throws IloException;
    ...
    public static class RltVarRowFilter implements RltRowFilter {
        ...
        @Override
        public void init(FastRlt rlt) throws IloException {
    ...
    private static final Logger log = Logger.getLogger(FastRlt.class);
    ...
    public FastRlt(IloCplex cplex, IloLPMatrix inputMatrix, RltParams prm) throws IloException {
