...
public class CcLeqConstraintsTest {
    ...
    public void testGetFactorsAsLeqConstraints() {
        ...
        factors.add(f1);
        factors.add(f2);
        CcLeqConstraints lc = CcLeqConstraints.getLeqFactorsAsLeqConstraints(factors, 3);
    ...
    public void testGetFactorsAsLeqConstraintsFail() {
        ...
        factors.add(f2);
        try {
            CcLeqConstraints.getLeqFactorsAsLeqConstraints(factors, 10);
            Assert.fail();    
